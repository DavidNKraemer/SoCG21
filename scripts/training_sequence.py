...
training_sequence = [
##########################################
# Learn how to finish and reach the target
##########################################
    {
        'description': 'one agent, finish east',
        'sources': np.array([[0,0]]),
        'targets': np.array([[1,0]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish west',
        'sources': np.array([[0,0]]),
        'targets': np.array([[-1,0]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish north',
        'sources': np.array([[0,0]]),
        'targets': np.array([[0,1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish south',
        'sources': np.array([[0,0]]),
        'targets': np.array([[0,-1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish northwest',
        'sources': np.array([[0,0]]),
        'targets': np.array([[-1,1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish southwest',
        'sources': np.array([[0,0]]),
        'targets': np.array([[-1,-1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish southeast',
        'sources': np.array([[0,0]]),
        'targets': np.array([[1,-1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
    {
        'description': 'one agent, finish northeast',
        'sources': np.array([[0,0]]),
        'targets': np.array([[1,1]]),
        'obstacles': np.array([[]]).reshape(-1,2),
    },
